...
// Fetch profile data
$stmt = $conn->prepare("SELECT u.name, u.email, u.contact, a.level FROM users u JOIN admins a ON u.u_id = a.u_id WHERE u.u_id = ?");
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['change_password'])) {
    ...
    if (empty($current) || empty($new) || empty($confirm)) {
        ...
        // Fetch hashed password from credentials table

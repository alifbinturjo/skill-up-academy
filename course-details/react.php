...
<div class="container py-5">
    ...
    <div class="mb-4">
        ...
        <div class="mt-3 text-center">
          <img src="../image-assets/course-images/react.webp" alt="React" class="img-fluid rounded shadow">
        </div>
    </div>
      ...
      <div class="accordion" id="courseOutline">
        <div class="accordion-item bg-transparent">
          ...
          <div id="module1" class="accordion-collapse collapse show" data-bs-parent="#courseOutline">
            <div class="accordion-body">
              Learn the basics of how react work and how they are built.
            </div>
          </div>
        </div>
        ...
        <div class="accordion-item bg-transparent">
          ...
          <div id="module2" class="accordion-collapse collapse" data-bs-parent="#courseOutline">
            <div class="accordion-body">
              Build beautiful web pages using react.
            </div>
          </div>
        </div>
